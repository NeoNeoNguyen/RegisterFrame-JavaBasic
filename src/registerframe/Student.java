...
public class Student implements Serializable {
    ...
    public Student(long id, String name, Date dob, String gender, String gmailId, String mobileNo, String password, String rePassword, String program, String branch, int semester, Timestamp addDate) {
        this.id = id;      
        this.dob = dob;
        this.gender = gender;
        this.mailId = mailId;
